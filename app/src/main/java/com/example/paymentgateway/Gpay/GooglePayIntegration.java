...
package com.example.paymentgateway.Gpay;
...
public class GooglePayIntegration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_pay_integration);
        ...
        upiId.setText("mukulyadav227@oka");
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!payerName.equals("") && !upiId.equals("") && !msgNote.equals("") && !sendAmount.equals("")){
                    ...
                    payWithGpay(GOOGLE_PAY_PACKAGE_NAME);

                }
                else {
                    Toast.makeText(GooglePayIntegration.this,"Fill all above details and try again.", Toast.LENGTH_SHORT).show();
    ...
    private void payWithGpay(String packageName){
        ...
        if(isAppInstalled(this,packageName)){
            ...
            Toast.makeText(GooglePayIntegration.this,"Google pay is not installed. Please istall and try again.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if ((RESULT_OK == resultCode) && status.equals("success")) {
            Toast.makeText(GooglePayIntegration.this, "Transaction successful. "+approvalRefNo, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(GooglePayIntegration.this, "Transaction cancelled or failed please try again.", Toast.LENGTH_SHORT).show();
